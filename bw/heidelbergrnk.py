...
def heidelbergrnk(sheets):
    ...
    data = get_json("https://services7.arcgis.com/0Uc5jDlEgdLosloE/arcgis/rest/services/dbdata_hd_rnk03/FeatureServer/0/query?where=date%3C%3D%27"+time.strftime("%Y-%m-%d")+"%27&outFields=*&orderByFields=date+desc&resultRecordCount=1&f=json")
