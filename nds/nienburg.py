...
def nienburg(sheets):
    ...
    ags, date = 3256, data["Letzte_Aktualisierung_text"].replace(",","").replace(" Uhr","")
    ...
    update(sheets, ags, c=c, cc=cc, g=g, gg=gg, d=d, dd=dd, q=q, sig="Bot", date=date, ignore_delta=True)
    return True
